...
const checkIn = function (flightNum, passenger) {
  ...
  if (passenger.passport === 23445212) {
    alert('Check in');
  } else {
...
lufthansa.book(239, 'Martin Drongos');
lufthansa.book(339, 'Jonas Yoni');
...
book.call(lufthansa, 239, 'Jose prado');
console.log(lufthansa);
...
book.call(swiss, 543, 'Martin Droga');
console.log(swiss);
// Apply method
